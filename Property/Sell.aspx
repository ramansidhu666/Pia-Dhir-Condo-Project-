<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true" CodeBehind="Sell.aspx.cs" Inherits="Property.Sell" %>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="contact_in_left">
                    ...
                    <div class="agent_input">
                     ...
                     <div class="agent_input">
                        <p>
                            Unit#:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                ControlToValidate="txtUnit" ValidationGroup="FreeHome" ForeColor="Red"
                                Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:TextBox ID="txtUnit" CssClass="CTextBox" runat="server" PlaceHolder="Unit" MaxLength="20"></asp:TextBox>
                           
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="FreeHome" runat="server" Display="Dynamic" ControlToValidate="txtUnit" ErrorMessage="Unit required" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </p>
                    </div><div class="agent_input">
                        <p>
                            Preferred Area:
