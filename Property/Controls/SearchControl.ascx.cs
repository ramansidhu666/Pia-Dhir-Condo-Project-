...
namespace Property.Controls
{
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                this.Page.Title = "Pia Dhir Realtor:Search Property";
                ...
                if (Request.QueryString["IsLease"] != ""&& Request.QueryString["IsLease"] != null)
                {
                    SearchCondoProperties("Lease");
                }
               else if (Convert.ToString(Session["QueryString"]) == "Residential" ||(Convert.ToString(Session["SearchType"]) == "Residential"))
        ...
        void SearchCondoProperties(string IsLease="")
        {
            try
            {
                Property1.MLSDataWebServiceSoapClient mlsClient = new Property1.MLSDataWebServiceSoapClient();
                ...
                if(IsLease!="")
                {
                    dt = mlsClient.GetProperties_Condo("0", "0", "0", "0", "0", "0", "Lease");
