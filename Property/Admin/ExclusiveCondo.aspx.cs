    ...
    public partial class ExclusiveCondo : System.Web.UI.Page
    {
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int DreamHouseId = clsobj.InsertExclusiveData(txtName.Text, fileNameForFirstImage, Server.HtmlEncode(txtDescription.Text), txtAddress.Text, txtPrice.Text,statustxt.Text,Typetxt.Text,Bedstxt.Text,Bathtxt.Text,Taxtxt.Text,Mlstxt.Text,Areatxt.Text);
